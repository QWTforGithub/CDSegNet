...
### ScanNet/ScanNet200
- The preprocess data of PTv3 can be directly downloaded [[Baidu Disk](https://pan.baidu.com/s/1RWMiyOpNwAEf9pCb5pizdw?pwd=1111)](code:1111) or [[here](https://huggingface.co/datasets/Pointcept/scannet-compressed)], please agree the official license before download it.
